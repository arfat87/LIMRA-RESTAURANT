...
async function main() {
  console.log('\n=============================================================');
  console.log(' LIMRA Restaurant - Apply Comprehensive Security Hardening');
  console.log('=============================================================\n');

  const migrationFile = path.resolve('migrations/20260618000000_harden_backend_security.sql');
  ...
  try {
    ...
    console.log('✅ Comprehensive backend security hardening migration applied successfully!');
