...
async function main() {
  console.log('\n===================================================');
  console.log(' LIMRA Restaurant - Database Input Validation Migration');
  console.log('===================================================\n');

  const migrationFile = path.resolve('migrations/20260615000000_add_input_validation.sql');
  ...
  try {
    ...
    console.log('✅ Input validation SQL migration applied successfully!');
