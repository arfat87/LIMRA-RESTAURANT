...
async function main() {
  console.log('\n===================================================');
  console.log(' LIMRA Restaurant - Apply Policy Hardening Migration');
  console.log('===================================================\n');

  const migrationFile = path.resolve('migrations/20260617000000_qualify_policy_functions.sql');
  ...
  try {
    ...
    console.log('✅ Security policy hardening SQL migration applied successfully!');
