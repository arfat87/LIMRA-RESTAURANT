...
const SQL_SCRIPT = `
-- Drop existing triggers and functions to avoid dependency issues
...
DROP FUNCTION IF EXISTS public.tr_on_order_insert() CASCADE;
DROP FUNCTION IF EXISTS public.tr_on_booking_insert() CASCADE;
DROP FUNCTION IF EXISTS public.tr_on_order_status_update() CASCADE;

-- Drop and recreate the notifications table with item_id as uuid
DROP TABLE IF EXISTS public.notifications CASCADE;

CREATE TABLE public.notifications (
  id bigint GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
  type text NOT NULL, -- 'order', 'booking', 'order_status'
  item_id uuid NOT NULL, -- changed from bigint to uuid
  title text NOT NULL,
