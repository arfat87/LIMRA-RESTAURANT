...
-- Simulate auth.uid() returning the user's ID
SET request.jwt.claims = '{"sub": "79a55132-8200-48bb-889f-28ddd838786c", "role": "authenticated"}';

-- Test auth.uid() directly
SELECT auth.uid() AS current_simulated_uid;

-- Test selecting from admin_users under this role
