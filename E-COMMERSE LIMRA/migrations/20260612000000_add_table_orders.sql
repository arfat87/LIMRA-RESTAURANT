-- Migration to add Table QR ordering columns and update place_order function
...
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS table_zone TEXT;
...
-- Recreate place_order with table ordering parameters
...
GRANT EXECUTE ON FUNCTION public.place_order(text, text, text, jsonb, numeric, numeric, text, text, boolean, text, integer, text) TO anon, authenticated;
